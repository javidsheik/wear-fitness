...
- (NSString *)makeString
{
    ...
    else
    {
        ...
        if (_unit)
        {
            finalText = [[NSString stringWithFormat:@"%d ", _value] stringByAppendingString:_unit];
        }
        else
        {
            finalText = [NSString stringWithFormat:@"%d", _value];
        }
    }
