...
- (BOOL)application:(UIApplication *)application didFinishLaunchingWithOptions:(NSDictionary *)launchOptions
{
    ...
    {
        [[NSUserDefaults standardUserDefaults] setObject:[NSNumber numberWithInt:3] forKey:@"screen"];
    }
    if(result.height == 568)
    {
        [[NSUserDefaults standardUserDefaults] setObject:[NSNumber numberWithInt:40] forKey:@"screen"];
    }
